...
class ColorString: NSObject {
    ...
    class func ColorString(_ name: String,fsize: CGFloat,frange: NSRange,color: UIColor,crange: NSRange) -> NSMutableAttributedString {
        ...
        AttributedStrss.addAttribute(NSAttributedString.Key.font, value: UIFont.systemFont(ofSize: fsize), range: frange)
        AttributedStrss.addAttribute(NSAttributedString.Key.foregroundColor, value: color, range: crange)
